...
export default function BereavementIntro() {
  return (
    <section
      ...
      className="bg-[var(--bg)] py-20 md:py-28 border-y border-[var(--border)] scroll-mt-[120px]"
    >
      <div className="max-w-content mx-auto px-6 text-center w-full">
        ...
        <p className="font-reading text-[clamp(16px,1.8vw,21px)] leading-[1.7] text-[var(--muted)] max-w-[860px] mx-auto">
